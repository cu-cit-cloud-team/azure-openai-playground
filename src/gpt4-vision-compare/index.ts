...
const imageOne = await fs.readFileSync(
  path.resolve(
...
const imageTwo = await fs.readFileSync(
  path.resolve(
    './src/dall-e-image-rest/generated-images/496d7a9c-b5bb-43a6-9d06-0d4475a6c939.png'
  ),
  'base64'
);
  ...
  messages: [
    {
      ...
      content: [
        ...
        },
        {
          type: 'image_url',
          image_url: {
            // url: 'https://raw.githubusercontent.com/CU-CommunityApps/ct-azure-openai-playground/main/src/dall-e-image-rest/generated-images/5d811f1e-5ad7-4d88-bb46-09ae474003b4.png',
            detail: 'auto',
            url: `data:image/png;base64,${imageOne}`,
          },
        },
        {
          type: 'image_url',
          image_url: {
            ...
            detail: 'auto',
            url: `data:image/png;base64,${imageTwo}`,
          },
        },
      ],
    },
